import "./chunk-UEBKKH7E.js";
import {
  SuiClient,
  getFullnodeUrl,
  isSuiClient
} from "./chunk-MLJNI2AE.js";
import {
  Hash,
  SUI_TYPE_ARG,
  Transaction,
...
} from "./chunk-4GHE2VD4.js";
import "./chunk-E2U4RKAK.js";
import "./chunk-QVB4MOAR.js";
import {
  useInfiniteQuery,
  useMutation,
  useQueries,
  useQuery
} from "./chunk-Z4NSDQSC.js";
import {
  require_jsx_runtime
...
var _createSponsoredTransaction;
var createSponsoredTransaction_fn;
var _executeSponsoredTransaction;
...
loadBag_fn = async function({
  ...
  if (!this.bagObject || !this.claimed) {
    await __privateMethod2(this, _loadBagObject, loadBagObject_fn).call(this);
  }
  if (!loadAssets) {
    return;
  }
...
_createSponsoredTransaction = /* @__PURE__ */ new WeakSet();
createSponsoredTransaction_fn = async function(tx, claimer, sender) {
  return __privateMethod2(this, _fetch2, fetch_fn).call(this, "transaction-blocks/sponsor", {
    method: "POST",
    body: JSON.stringify({
...
_executeSponsoredTransaction = /* @__PURE__ */ new WeakSet();
executeSponsoredTransaction_fn = async function(input, signature) {
  return __privateMethod2(this, _fetch2, fetch_fn).call(this, `transaction-blocks/sponsor/${input.digest}`, {
    method: "POST",
    body: JSON.stringify({
      signature
    })
...
var StashedPopup = class {
  constructor({ name, origin = DEFAULT_STASHED_ORIGIN }) {
    __privateAdd3(this, _listener);
    __privateAdd3(this, _cleanup);
    __privateAdd3(this, _popup, void 0);
    __privateAdd3(this, _id, void 0);
    __privateAdd3(this, _origin, void 0);
    __privateAdd3(this, _name, void 0);
    __privateAdd3(this, _promise, void 0);
    __privateAdd3(this, _resolve, void 0);
    __privateAdd3(this, _reject, void 0);
    ...
    __privateSet4(this, _interval, setInterval(() => {
      try {
        if (__privateGet5(this, _popup).closed) {
          __privateMethod3(this, _cleanup, cleanup_fn).call(this);
  ...
  send({
    ...
    window.addEventListener("message", __privateMethod3(this, _listener, listener_fn));
...
_cleanup = /* @__PURE__ */ new WeakSet();
cleanup_fn = function() {
  if (__privateGet5(this, _interval)) {
    clearInterval(__privateGet5(this, _interval));
    __privateSet4(this, _interval, null);
  }
  window.removeEventListener("message", __privateMethod3(this, _listener, listener_fn));
};
...
var StashedWallet = class {
  constructor({
    ...
    __privateAdd4(this, _setAccount);
    __privateAdd4(this, _events, void 0);
    __privateAdd4(this, _accounts, void 0);
    __privateAdd4(this, _origin2, void 0);
    __privateAdd4(this, _name2, void 0);
    ...
    __privateAdd4(this, _connect, async (input) => {
      if (input == null ? void 0 : input.silent) {
        ...
        if (address2) {
          __privateMethod4(this, _setAccount, setAccount_fn).call(this, address2);
        }
      ...
      __privateMethod4(this, _setAccount, setAccount_fn).call(this, response.address);
      return { accounts: this.accounts };
    });
    __privateAdd4(this, _disconnect, async () => {
      localStorage.removeItem(STASHED_RECENT_ADDRESS_KEY);
      __privateMethod4(this, _setAccount, setAccount_fn).call(this);
    });
    ...
    if (address) {
      __privateMethod4(this, _setAccount, setAccount_fn).call(this, address);
    }
  }
  get name() {
...
// node_modules/@vanilla-extract/css/dist/transformCss-4c9a03c9.browser.esm.js
