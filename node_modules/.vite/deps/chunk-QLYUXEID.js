...
var TypeTag = union([
  ...
  object({ struct: recursive(() => StructTag2) }),
...
var ObjectCache = class {
  constructor({ cache = new InMemoryCache() }) {
    __privateAdd2(this, _cache, void 0);
...
var CachingTransactionExecutor = class {
  constructor({
    ...
    __privateAdd3(this, _client, void 0);
...
var SerialTransactionExecutor = class {
  constructor({
    ...
    __privateAdd5(this, _signer, void 0);
    __privateAdd5(this, _cache2, void 0);
...
var ParallelTransactionExecutor = class {
  constructor(options) {
    __privateAdd6(this, _getUsedObjects);
    __privateAdd6(this, _execute);
    __privateAdd6(this, _getGasCoin);
    __privateAdd6(this, _refillCoinPool);
    __privateAdd6(this, _signer2, void 0);
    __privateAdd6(this, _client2, void 0);
    __privateAdd6(this, _coinBatchSize, void 0);
    __privateAdd6(this, _initialCoinBalance, void 0);
    __privateAdd6(this, _minimumCoinBalance, void 0);
    __privateAdd6(this, _maxPoolSize, void 0);
    __privateAdd6(this, _sourceCoins, void 0);
    __privateAdd6(this, _coinPool, []);
    __privateAdd6(this, _cache3, void 0);
    __privateAdd6(this, _objectIdQueues, /* @__PURE__ */ new Map());
    __privateAdd6(this, _buildQueue, new SerialQueue());
    __privateAdd6(this, _executeQueue, void 0);
  ...
  resetCache() {
    return __privateGet6(this, _cache3).reset();
  }
...
execute_fn = async function(transaction, usedObjects) {
  ...
  let gasCoin;
  try {
    const bytes2 = await __privateGet6(this, _buildQueue).runTask(async () => {
      ...
      return __privateGet6(this, _cache3).buildTransaction({ transaction });
    });
    ...
    if (gasCoin && gasUsed && gasResult.owner === __privateGet6(this, _signer2).toSuiAddress()) {
      ...
      if (gasCoin.balance >= __privateGet6(this, _minimumCoinBalance)) {
    ...
    await __privateGet6(this, _cache3).cache.deleteObjects([...usedObjects]);
    throw error;
  } finally {
    usedObjects.forEach((objectId) => {
      const queue = __privateGet6(this, _objectIdQueues).get(objectId);
...
getGasCoin_fn = async function() {
  if (__privateGet6(this, _coinPool).length === 0 && __privateGet6(this, _executeQueue).activeTasks <= __privateGet6(this, _maxPoolSize)) {
...
refillCoinPool_fn = async function() {
  ...
  const batchSize = Math.min(
    ...
    __privateGet6(this, _maxPoolSize) - (__privateGet6(this, _coinPool).length + __privateGet6(this, _executeQueue).activeTasks) + 1
  );
  if (batchSize === 0) {
    return;
  }
...
*/
//# sourceMappingURL=chunk-QLYUXEID.js.map
