...
var _popup, _id, _origin, _name, _promise, _resolve, _reject, _interval, _listener, listener_fn, _cleanup, cleanup_fn, _request;
...
class StashedPopup {
  ...
  send({
    ...
    window.addEventListener("message", __privateMethod(this, _listener, listener_fn));
...
cleanup_fn = function() {
  ...
  window.removeEventListener("message", __privateMethod(this, _listener, listener_fn));
};
